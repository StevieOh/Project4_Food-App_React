  ...
  render() {
    return (
      <div>
        ...
        { this.state.restaurantsFetch ? this.state.restaurants.map((restaurant, i) => <RestaurantList keys={i} restaurant={this.state.restaurants}/>) : <Search handleSubmit={this.handleSubmit} /> }
